          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
            ...
            <div className="flex flex-col gap-4">
              <div>
                ...
                <div className="bg-bg-secondary rounded-xl border border-border-default flex items-start gap-3 mt-4" style={{ paddingTop: '0.5rem', paddingBottom: '0.5rem', paddingLeft: '1.5rem', paddingRight: '1.5rem' }}>
                ...
                {activeStepData.hashDetails && (
                  <div className="bg-bg-primary rounded-xl border border-border-default font-mono text-sm leading-relaxed overflow-hidden mt-4" style={{ paddingTop: '0.5rem', paddingBottom: '0.5rem', paddingLeft: '1.5rem', paddingRight: '1.5rem' }}>
            ...
            <div className="flex flex-col justify-center items-center min-h-[320px] border border-border-default bg-bg-primary/50 rounded-xl relative overflow-hidden p-6">
              ...
              {activeVisTab === 'flow' ? (
                <div className="flex flex-col items-center justify-center p-6 bg-bg-secondary rounded-xl border border-border-default/50 max-w-sm mx-auto w-full gap-4 font-mono select-none">
                  <div className={`p-3 rounded-lg border text-center transition-all duration-300 w-full ${activeStepData.flowActiveStep === 0 ? 'bg-accent-tertiary/20 border-accent-tertiary text-accent-tertiary shadow-[0_0_12px_rgba(255,224,74,0.15)] font-bold' : 'border-border-default/40 text-text-secondary'}`}>
                    Key Entered ("APPLE")
                  </div>
                  <div className="text-text-muted text-sm">&darr;</div>
                  <div className={`p-3 rounded-lg border text-center transition-all duration-300 w-full ${activeStepData.flowActiveStep === 1 ? 'bg-accent-tertiary/20 border-accent-tertiary text-accent-tertiary shadow-[0_0_12px_rgba(255,224,74,0.15)] font-bold' : 'border-border-default/40 text-text-secondary'}`}>
                    Hash Function: hash()
                  </div>
                  <div className="text-text-muted text-sm">&darr;</div>
                  <div className={`p-3 rounded-lg border text-center transition-all duration-300 w-full ${activeStepData.flowActiveStep === 2 ? 'bg-accent-tertiary/20 border-accent-tertiary text-accent-tertiary shadow-[0_0_12px_rgba(255,224,74,0.15)] font-bold' : 'border-border-default/40 text-text-secondary'}`}>
                    Generate Index (3)
                  </div>
                  <div className="text-text-muted text-sm">&darr;</div>
                  <div className={`p-3 rounded-lg border text-center transition-all duration-300 w-full ${activeStepData.flowActiveStep === 3 ? 'bg-accent-tertiary/20 border-accent-tertiary text-accent-tertiary shadow-[0_0_12px_rgba(255,224,74,0.15)] font-bold' : 'border-border-default/40 text-text-secondary'}`}>

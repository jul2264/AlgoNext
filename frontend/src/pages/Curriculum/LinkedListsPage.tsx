                    ...
                    return (
                      <div key={idx} className="flex items-center gap-2 sm:gap-4 relative">
                        ...
                        <div className="flex flex-col items-center gap-1 relative">
                          ...
                          {pointerLabel && (
                            <div className="absolute top-full left-1/2 -translate-x-1/2 mt-4 px-3.5 py-2 bg-accent-primary text-bg-primary rounded text-xs font-mono font-bold uppercase whitespace-nowrap shadow-md select-none leading-none">
                              {pointerLabel}
                            </div>
                          )}
                        </div>

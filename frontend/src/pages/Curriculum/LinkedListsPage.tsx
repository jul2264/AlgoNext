        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
          ...
          <div className="lg:col-span-7 neon-card neon-card-yellow flex flex-col gap-6" style={{ paddingTop: '1.25rem', paddingBottom: '1.25rem', paddingLeft: '1.5rem', paddingRight: '1.5rem' }}>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              <div>
                <h3 className="text-base font-bold text-accent-primary font-mono mb-[0.5rem] uppercase flex flex-row items-baseline gap-2 flex-wrap">
              ...
              <div>
                <h3 className="text-base font-bold text-accent-secondary font-mono mb-[0.5rem] uppercase flex flex-row items-baseline gap-2 flex-wrap">
              ...
              <div>
                <h3 className="text-base font-bold text-accent-tertiary font-mono mb-[0.5rem] uppercase flex flex-row items-baseline gap-2 flex-wrap">

          ...
          <div className="neon-card neon-card-cyan flex flex-col justify-start" style={{ paddingTop: '0.5rem', paddingBottom: '0.5rem', paddingLeft: '1.5rem', paddingRight: '1.5rem' }}>
            ...
            <div className="space-y-3 text-sm text-text-secondary leading-relaxed">
              ...
              <div className="mt-4">
                ...
                <div className="bg-transparent p-4 flex flex-col font-mono text-sm select-none">
                    ...
                    return (
                      <div key={idx} className="flex items-center gap-2 sm:gap-4 relative">
                        ...
                        <div className="flex flex-col items-center gap-1 relative">
                          ...
                          {pointerLabel && (
                            <div className="absolute bottom-full left-1/2 -translate-x-1/2 -translate-y-5 px-16 py-8 bg-accent-primary text-bg-primary rounded text-xs font-mono font-bold uppercase whitespace-nowrap shadow-md select-none leading-none">
                              {pointerLabel}
                            </div>
                          )}
                        </div>
